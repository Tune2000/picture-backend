package com.tune.picturebackend.manager.auth;
...
import com.tune.picturebackend.manager.auth.model.SpaceUserAuthConfig;
import com.tune.picturebackend.manager.auth.model.SpaceUserRole;
...
public class SpaceUserAuthManager {
    ...
    public List<String> getPermissionList(Space space) {
        ...
        switch (spaceTypeEnum) {
            case PRIVATE:
                // 私有空间，仅本人或管理员有所有权限
                if (space.getUserId().equals(loginUser.getId()) || isAdmin) {
                    return ADMIN_PERMISSIONS;
                } else {
                    return new ArrayList<>();
                }
